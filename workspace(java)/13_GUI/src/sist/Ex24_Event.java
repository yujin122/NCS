 ...
 * 		이벤트에 관련된 여러 정보를 담고 있는 객체임. 이벤트 객체 내에 저장되는 정보 중에
 * 		특별히 이벤트를 방생시킨 컴포넌트를 이벤트 소스라고 부름. 여기서 이벤트 소스는
 ...
 * 								- 이벤트 소스와 이벤트 핸들러를 연결
 * - 이벤트 분배 스레드 : 이벤트 기반 프로그래밍의 핵심 요소로서 무한르프를 실행하는
