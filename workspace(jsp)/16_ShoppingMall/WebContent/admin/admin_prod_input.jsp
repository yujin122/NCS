...
<body>
	...
	<div align = "center">
		...
		<hr width = "50%" color = "blue">
		<br>
		<form method = "post" action = "admin_prod_input_ok.do" enctype = "multipart/form-data">
			<table border = "1" cellspacing = "0" width = "400">
				...
				<tr>
					<th>상품 가격</th>
					<td><input type = "text" name = "p_price" maxlength = "8"></td>
				</tr>
				<tr>
					<th>상품 사양</th>
					<td>
				...
				<tr>
					<th>상품 포인트</th>
					<td><input type = "text" name = "p_point"></td>
				</tr>
				<tr>
