...
public class AdderServlet02 extends HttpServlet {
	...
	/*
	 * 요청과 관련된 API : javax.servlet.HttpServletRequest 인터페이스
	 * 응답과 관련된 API : javax.servlet.HttpServletResponse 인터페이스
	 ...
	 * 1. get 방식
	 * 	  - 서블릿에 데이터를 전송할 때는 데이터가 url 뒤에 name=vlaue 형태로 전송이 됨 
